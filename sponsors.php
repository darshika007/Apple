...
if(isset($_POST['submit']))
{
    ...
    $sname=$_POST['sname'];
    $sql = "INSERT INTO sponser values('NULL','$f1','$sname')";
...
<body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
        ...
        <ul class="app-menu">
            ...
            <li>
                <a class="app-menu__item active" href="sponsors.php">
                    <i class="app-menu__icon fa fa-clipboard"></i>
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1>
                    <i class="app-menu__icon fa fa-clipboard"></i>Sponsors</h1>
            </div>
...
if(isset($_REQUEST["delid"]))
{
    ...
    $sql="DELETE FROM sponser where id='$delid'";
    $res=mysqli_query($con,$sql);
    if($res){
    }
}
//end delete query
                        $query=mysqli_query($con,"SELECT * FROM sponser");
                while ($row = mysqli_fetch_array($query)) { 
                    ?>
                           ...
                           <i class='fa fa-file-image-o' aria-hidden='true' data-toggle='modal'data-target='#imageModal<?php echo $row['id'] ?>'></i>
                                ...
                                <td>
                                <?php
                               echo "<a href='sponsors.php?delid=".$row['id']."'> <button type='button' class='btn btn-danger btn-sm'>
                                        Delete
                                    </button></a>";
                                    ?>
                                </td>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <img src="<?php echo '../admin/Pictures/'. $row['file1']; ?>" height="350px;" width="300px;">
                    </div>
