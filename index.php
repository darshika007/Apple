...
if(isset($_POST['approve'])){
    $id=$_POST['id'];
echo '$status';
$sql="UPDATE regis set status='approve' where id='$id'";
...
<body class="app sidebar-mini rtl">
  ...
  <main class="app-content">
    <div class="app-title">
      <div>
        <h1>
          <i class="fa fa-user"></i> User Details</h1>
      </div>
    ...
    <table class="table table-hover table-dark table-responsive">
        ...
        <tbody>
          <?php
            $query=mysqli_query($con,"SELECT * FROM regis WHERE status='approve' or status='pending'");
            while ($row = mysqli_fetch_array($query)) {
              ...
              <tr>
                ...
                <button ID='button' name='approve' class='btn btn-success btn-sm' value='approve' />Approve</button>
                <button ID='button' name='reject' class='btn btn-danger btn-sm' value='reject' />Reject</button></td>
                </form>
          </tr>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Iusto soluta saepe unde quos accusamus ipsa explicabo officiis! Adipisci et, deleniti laboriosam, numquam animi earum dolorem autem praesentium culpa enim repellat.
        </div>
