...
if(isset($_POST['submit']))
{
    ...
    if(mysqli_num_rows($query)>0){
        ...
        alert('already a profile is there')</script>";
        echo "<script>window.location.href='venue_gallery.php'</script>"; 
    }

else{
    $sql = "INSERT INTO profile values('NULL','$f1','$cname')";
        ...
        <?php 
                ...
                <div class="col-md-4 ">
                    ...
                    <a href="venue_gallery.php?cnameid=<?php echo $row['cname']; ?>"><div class="content-overlay"></div>
                        <img class="content-image" src="<?php echo '../admin/Pictures/'. $row['file1']; ?>" height="300px;" width="295px;" style="margin-left:20px;">
